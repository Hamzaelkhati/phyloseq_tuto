...
#On peut avoir une autre alternative pour pouvoir utiliser IdTaxa. Il y a une meilleure assignation taxonomique qu’avec l’autre (NBG classifier). Dans le jeu de données, il y avait une Mock community (souches connues dans des proportions connues). C’est le seul éléments de données qui permet d’avoir un recul sur le pipeline.
